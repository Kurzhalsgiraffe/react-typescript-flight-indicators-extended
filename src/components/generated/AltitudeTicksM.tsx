...
const SvgAltitudeTicksM = (props: SVGProps<SVGSVGElement>) => (
    ...
    >
        ...
        <path
            fill="none"
            d="m174.243 243.809 61.533 38.566a89 89 0 0 0 8.936-4.471l-66.101-41.43zM165.159 259.06l47.482 29.761a89 89 0 0 0 12.055-2.517l-55.169-34.578zM214.732 238.17a40.2 40.2 0 0 1-11.956 2.578l34.692 21.744-9.571-16.07zM156.076 274.312l18.447 11.562a89.4 89.4 0 0 0 21.967 3.696l-36.045-22.592z"
        />
        <path
            fill="#fff"
